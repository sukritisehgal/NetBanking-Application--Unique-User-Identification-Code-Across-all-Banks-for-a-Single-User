...
public class ICICI implements RBI {
   ...
   // Scanner s=new Scanner(System.in);
    ...
    {
        JFrame jfrm = new JFrame("Open ICICI account Page");
        ...
        try
        {
            ...
            PreparedStatement stmt=con.prepareStatement("insert into icici values(?,?,?,?,?,?)");
    ...
    public void delete_acc()
    {
        ...
        try
        {
            ...
            ResultSet rs=stmt.executeQuery("select acc_no from icici");
            ...
            else if (flag==1)
            {
                ...
                if(jtf2.getText().equals("yes"))
                {
                    try
                    {
                        PreparedStatement ptst=con.prepareStatement("delete from icici where acc_no=?");
    ...
    {
        JFrame jfrm = new JFrame("ICICI Updation Page");
        jfrm.setLayout(new FlowLayout());
        jfrm.setBackground(Color.YELLOW);
        jfrm.setForeground(Color.BLACK);
        jfrm.setSize(500, 500);
        ...
        try
        {
           ...
           PreparedStatement stmt=con.prepareStatement("update icici set name=?, age=?,loan=?,tax=? where acc_no=?");
    ...
    public void pay_tax()
    {
        JFrame jfrm = new JFrame("ICICI TAX Page");
        jfrm.setLayout(new FlowLayout());
        jfrm.setBackground(Color.YELLOW);
        jfrm.setForeground(Color.BLACK);
        jfrm.setSize(500, 500);
        ...
        try
        {
            ...
            else if (flag==1)
            {
                ...
                PreparedStatement ptst=con.prepareStatement("update icici set tax=? where acc_no=?");
                ptst.setInt(1, tax);
    ...
    {
        JFrame jfrm = new JFrame("ICICI Loan Page");
        jfrm.setLayout(new FlowLayout());
        jfrm.setBackground(Color.YELLOW);
        jfrm.setForeground(Color.BLACK);
        jfrm.setSize(500, 500);
        ...
        try
        {
            ...
            else if (flag==1)
            {
                ...
                PreparedStatement ptst=con.prepareStatement("update icici set loan=? where acc_no=?");
    ...
    public void options()
    {
        JFrame jfrm = new JFrame("ICICI Options Page");
        jfrm.setLayout(new FlowLayout());
        jfrm.setBackground(Color.YELLOW);
        jfrm.setForeground(Color.BLACK);
        jfrm.setSize(500, 500);
