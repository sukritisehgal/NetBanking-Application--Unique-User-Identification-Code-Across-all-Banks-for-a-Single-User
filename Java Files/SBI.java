...
public class SBI implements RBI {
    ...
    {
        JFrame jfrm = new JFrame("Open SBI account Page");
        ...
        try
        {
            ...
            PreparedStatement stmt=con.prepareStatement("insert into sbi values(?,?,?,?,?,?)");
    ...
    public void delete_acc()
    {
        ...
        try
        {
            ...
            ResultSet rs=stmt.executeQuery("select acc_no from sbi");
            ...
            else if (flag==1)
            {
                ...
                if(jtf2.getText().equals("yes"))
                {
                    try
                    {
                        PreparedStatement ptst=con.prepareStatement("delete from sbi where acc_no=?");
    ...
    {
        JFrame jfrm = new JFrame("SBI Updation Page");
        jfrm.setLayout(new FlowLayout());
        jfrm.setBackground(Color.YELLOW);
        jfrm.setForeground(Color.BLACK);
        jfrm.setSize(500, 500);
        ...
        try
        {
           ...
           PreparedStatement stmt=con.prepareStatement("update sbi set name=?, age=?,loan=?,tax=? where acc_no=?");
    ...
    public void pay_tax()
    {
        JFrame jfrm = new JFrame("SBI TAX Page");
        jfrm.setLayout(new FlowLayout());
        jfrm.setBackground(Color.YELLOW);
        jfrm.setForeground(Color.BLACK);
        jfrm.setSize(500, 500);
        ...
        try
        {
            ...
            else if (flag==1)
            {
                ...
                PreparedStatement ptst=con.prepareStatement("update sbi set tax=? where acc_no=?");
                ptst.setInt(1, tax);
    ...
    {
        JFrame jfrm = new JFrame("SBI Loan Page");
        jfrm.setLayout(new FlowLayout());
        jfrm.setBackground(Color.YELLOW);
        jfrm.setForeground(Color.BLACK);
        jfrm.setSize(500, 500);
        ...
        try
        {
            ...
            else if (flag==1)
            {
                ...
                PreparedStatement ptst=con.prepareStatement("update sbi set loan=? where acc_no=?");
                ...
                rs=stmt.executeQuery("select * from sbi");
    ...
    public void options()
    {
        JFrame jfrm = new JFrame("SBI Options Page");
        jfrm.setLayout(new FlowLayout());
        jfrm.setBackground(Color.YELLOW);
        jfrm.setForeground(Color.BLACK);
        jfrm.setSize(500, 500);
