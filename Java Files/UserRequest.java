    ...
    public void execute(int unique_id)
    {
        ...
        try 
        {
            ...
            if(sbi==0)
            {
                ...
                jfrm.add(jlab);
                JButton Enter = new JButton("<html><br>Drop a Request to open a new SBI account</html>");
               
                Enter.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent ae) {
                        
                    UserDisplay obj=new UserDisplay();
                    obj.execute();
            ...
            if(hdfc==0)
            {
                ...
                jfrm.add(jlab);
                JButton Enter = new JButton("<html><br>Drop a request to open a new HDFC account</html>");
            ...
            if(icici==0)
            {
                ...
                jfrm.add(jlab);
                JButton Enter = new JButton("<html><br>Drop a request to open a new ICICI account</html>");
            ...
            if(sbi==1)
            {
                ...
                JButton Enter = new JButton("Drop a request to modify SBI account");
            ...
            if(hdfc==1)
            {
                ...
                jfrm.add(jlab);
                JButton Enter = new JButton("Drop a request to modify HDFC account");
            ...
            if(icici==1)
            {
                ...
                jfrm.add(jlab);
                JButton Enter = new JButton("Drop a request to modify ICICI account");
